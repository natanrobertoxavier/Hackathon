...
using Doctor.Persistence.Infrastructure.Repositories.Doctor;
...
namespace Doctor.Persistence.Infrastructure;
        ...
        if (!databaseInMemory)
        {
            services.AddFluentMigratorCore().ConfigureRunner(c =>
                 c.AddMySql5()
                  ...
                  .ScanIn(Assembly.Load("Doctor.Persistence.Infrastructure")).For.All());
        }
    }
