...
public class DoctorRepositoryTests
{
    ...
    public async Task AddAsync_ShouldAddDoctorToDatabase()
    {
        ...
        var doctor = new Domain.Entities.Doctor(Guid.NewGuid(), DateTime.UtcNow, "Doctor Name", "Name", "email@example.com", "12345", "password", Guid.NewGuid(), 0.0m);
    ...
    public async Task RecoverAllAsync_ShouldReturnPagedDoctors()
    {
        ...
        {
            new Domain.Entities.Doctor(Guid.NewGuid(), DateTime.UtcNow, "Doctor 1", "Name1", "email1@example.com", "CR1", "password1", Guid.NewGuid(), 0.0m),
            new Domain.Entities.Doctor(Guid.NewGuid(), DateTime.UtcNow, "Doctor 2", "Name2", "email2@example.com", "CR2", "password2", Guid.NewGuid(), 0.0m),
            new Domain.Entities.Doctor(Guid.NewGuid(), DateTime.UtcNow, "Doctor 3", "Name3", "email3@example.com", "CR3", "password3", Guid.NewGuid(), 0.0m)
        };
