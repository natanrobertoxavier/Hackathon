...
public class RecoverAllUseCaseTests
{
    ...
    public async Task RecoverAllAsync_ShouldReturnSuccess_WhenDoctorsAreFound()
    {
        ...
        {
            new Domain.Entities.Doctor(doctorId1, DateTime.UtcNow, "Doctor 1", "email1@example.com", "CR1", "password1", specialty.Id),
            new Domain.Entities.Doctor(doctorId2, DateTime.UtcNow, "Doctor 2", "email2@example.com", "CR2", "password2", specialty.Id)
        };
